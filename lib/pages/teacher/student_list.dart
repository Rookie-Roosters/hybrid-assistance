  ...
  Widget build(BuildContext context) {
    return controller.obx((state) {
      return Scaffold(
        ...
        WorthyText.body(controller.selectedClass.startTime.toString().substring(11, 16) + " - " + controller.selectedClass.endTime.toString().substring(11, 16),
            textAlign: TextAlign.center),
        ...
        Visibility(
            //stat: muestra si los status ya son visibles
        ...
        Visibility(
          //hide: esconde lo relacionado a la edicion
            ...
            ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return ListTile(
                        ...
                        Transform.scale(
                            ...
                            child: Obx(
                              () => Radio<AttendanceStatus>(
                                ...
                                groupValue: controller.attendanceList[index].status,
                    ...
                    title: WorthyText.bodyLarge(controller.attendanceList[index].name +
                        " " +
                        controller.attendanceList[index].firstLastName +
                        " " +
                        controller.attendanceList[index].secondLastName),
                  );
                })
          ])
