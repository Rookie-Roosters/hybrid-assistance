     ...
     return controller.obx((state) {
      return Scaffold(
          body: Column(
            ...
            kSpacerY5,
            Visibility (visible: (controller.todaysAttendance.status.index == 0), child:
                Column(
                  mainAxisSize: MainAxisSize.max,
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
              ...
              child: WorthyContainer(child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                RadioListTile<AttendanceStatus>(title:WorthyText.bodyLarge(AttendanceStatus.present.statusName), value: AttendanceStatus.present, groupValue: controller
                                            .selectedStatus, onChanged: (value) =>controller.changeStatus(value!),
                                      ),
                RadioListTile<AttendanceStatus>(title:WorthyText.bodyLarge(AttendanceStatus.online.statusName), value: AttendanceStatus.online, groupValue: controller
                                            .selectedStatus, onChanged: (value) => controller.changeStatus(value!),
                ...
                WorthyButton.elevated(
                  ...
                  ])else if (!controller.stat) WorthyText.heading3(controller.message),
            kSpacer,
          ]));
